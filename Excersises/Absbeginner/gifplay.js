            ...
            dataSource: [
                {
                    ...
                    caption: 'Warming up',
                    url: require('../gifs/abdiominalcrunches.gif'),
                },{
                    title: 'Russian twist',
                    caption: 'Working up',
                    url: require('../gifs/russiantwist.gif'),
                },{
                    title: 'Mountain_Climber',
                    caption: 'Keep it up',
                    url: require('../gifs/Mountain_Climber.gif'),
                },{
                    title: 'Alternate heel touch',
                    caption: 'In progress',
                    url: require('../gifs/alternateheel.gif'),
                },{
                    ...
                    url: require('../gifs/plankl.gif'),
                },
                {
                    title: 'cobra stretch',
                    caption: 'Last One keep it up',
                    url: require('../gifs/cobarastreatch.gif'),
                },
            ],
        };
    }
        ...
        return (
            <View style={{flex:1,flexDirection:'column',backgroundColor:'#363636'}}>
                ...
                <ScrollView>
                    ...
                    <Text style={{textAlign:'center',fontSize:25,fontWeight:'bold',color:'white',margin:15}}>Abs Easy</Text>
