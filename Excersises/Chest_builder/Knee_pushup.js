...
export default class Knee_pushup extends Component{
            ...
            <View style={{backgroundColor: '#3C3C3C',height:'100%',}}>
                ...
                <View style={{backgroundColor: '#616363',margin:15,borderRadius:15,marginTop:0,padding:5}}>
                    <ScrollView>
                        ...
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} Place your hand on the ground ,shoulder wide apart</Text>
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} Lower your torso to the ground until your elbow from a 90 degree angle.</Text>
