...
export default class Bulgarian_squat extends Component{
            ...
            <View style={{backgroundColor: '#3C3C3C',height:'100%',}}>
                ...
                <View style={{backgroundColor: '#616363',margin:15,borderRadius:15,marginTop:0,padding:5}}>
                    <ScrollView>
                        ...
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} Get into a forward lunge position with torso upright</Text>
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} with your back foot elevated on the bench. </Text>
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} ower until your front thigh is almost horizontal, keeping your knee in line with your foot.</Text>
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} Drive up through your front heel back to the starting position</Text>
