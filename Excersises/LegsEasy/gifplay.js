            ...
            dataSource: [
                {
                    ...
                    url: require('../gifs/sidehop.gif'),
                },{
                    title: 'Squat',
                    caption: 'Warming up',
                    url: require('../gifs/Squatjump.gif'),
                },{
                    title: 'Side Lying Leg',
                    caption: 'Warming up',
                    url: require('../gifs/sidelyingleg.gif'),
                },
             {
                    title: 'Lunge',
                    caption: 'Keep it up',
                    ...
                    title: 'Donkey kicks',
                    caption: 'In progress',
                    url: require('../gifs/donkeykicks.gif'),
                },{
                    title: 'Quad Stretch',
                    caption: 'good things not come so fast',
                    url: require('../gifs/quadstretch.gif'),
                },{
                    title: 'Wall calf raise',
                    caption: 'muscle is burning up',
                    url: require('../gifs/wallcalf.gif'),
                },{
                    title: 'Calf raise',
                    caption: '5 more',
                    url: require('../gifs/Calf_raise.gif'),
                },{
                    title: 'Triceps Dumbbell',
                    caption: 'Cant quit right now',
                    url: require('../gifs/Triceps_Dumbell.gif'),
                },
                {
                    title: 'Dumbbell biceps curl',
                    caption: 'We are hear to make it work',
        ...
        return (
            <View style={{flex:1,flexDirection:'column',backgroundColor:'#363636'}}>
                ...
                <ScrollView>
                    ...
                    <Text style={{textAlign:'center',fontSize:25,fontWeight:'bold',color:'white',margin:15}}>Legs Easy</Text>
