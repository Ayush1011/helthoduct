...
export default class Abs_Streach extends Component{
            ...
            <View style={{backgroundColor: '#3C3C3C',height:'100%',}}>
                ...
                <View style={{backgroundColor: '#616363',margin:15,borderRadius:15,marginTop:0,padding:5}}>
                    <ScrollView>
                        ...
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'}  Begin by lying on the floor with your legs fully extended and arms just below shoulder level</Text>
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} Push only your Lower body up,.</Text>
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} Continue until just before you can no longer maintain contact with the ground.</Text>
