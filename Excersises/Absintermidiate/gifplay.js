            ...
            dataSource: [
                {
                    ...
                    title: 'Alternate heel',
                    caption: 'Warming up',
                    url: require('../gifs/alternateheel.gif'),
                },{
                    title: 'Crossover Crunch',
                    caption: 'Working up',
                    url: require('../gifs/crossovercrunches.gif'),
                },{
                    ...
                    title: 'Side bridge',
                    caption: 'In progress',
                    url: require('../gifs/sidebridge.gif'),
                },{
                    title: 'Butt bridge',
                    ...
                    url: require('../gifs/vup.gif'),
                },
                {
                    title: 'Leg Raise',
                    caption: '3 more steps',
                    url: require('../gifs/legraise.gif'),
                },
                {
                    title: 'Side Plank',
                    caption: 'Good things comes slow',
                    url: require('../gifs/sideplank.png'),
                },
                {
