            ...
            dataSource: [
                {
                    ...
                    title: 'Wide push up',
                    caption: 'Warming up',
                    url: require('../gifs/widepushup.gif'),
                },{
                    title: 'One Arm push up',
                    caption: 'Working up',
                    url: require('../gifs/onearmpushup.gif'),
                },{
                    title: 'Triceps Stretch',
                    caption: 'Keep it up',
                    url: require('../gifs/tricepsstretch.gif'),
                },{
                    title: 'One arm push up',
                    caption: 'In progress',
                    url: require('../gifs/onearmpushup.gif'),
                    ...
                    url: require('../gifs/cheststretch.gif'),
                },
            ],
        };
    }
        ...
        return (
            <View style={{flex:1,flexDirection:'column',backgroundColor:'#363636'}}>
                ...
                <ScrollView>
                    ...
                    <Text style={{textAlign:'center',fontSize:25,fontWeight:'bold',color:'white',margin:15}}>Chest Booster</Text>
                    ...
                    </View><View style={{flex:1,flexDirection:'row',backgroundColor:'#313131',justifyContent:'center',alignItems:'center',alignSelf:'center',height:60,margin:'4%',borderRadius:5,width:200}}>
