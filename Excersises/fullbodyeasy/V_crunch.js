...
export default class V_crunch extends Component{
    ...
    render(){
        return(
            ...
            <View style={{backgroundColor: '#3C3C3C',height:'100%',}}>
                <Image
                    source={require('../gifs/vcrunch.gif')}
                ...
                <View style={{backgroundColor: '#616363',margin:15,borderRadius:15,marginTop:0,padding:5}}>
                    <ScrollView>
                        ...
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} Lie on your back, and lift your legs and arms up so they are extended toward the ceiling.</Text>
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} Lift your upper back off the floor, reaching your hands toward your feet.</Text>
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} Lower your legs toward the floor while reaching your arms overhead, </Text>
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} keeping your shoulders off the mat and lower back pressed into the mat.</Text>
