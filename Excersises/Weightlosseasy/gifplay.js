            ...
            dataSource: [
                {
                    ...
                    caption: 'In progress',
                    url: require('../gifs/DUmbellfrontraise.gif'),
                },{
                    ...
                    url: require('../gifs/Superman_gif.gif'),
                },
            ],
        };
    }
        ...
        return (
            <View style={{flex:1,flexDirection:'column',backgroundColor:'#363636'}}>
                ...
                <ScrollView>
                    ...
                    <Text style={{textAlign:'center',fontSize:25,fontWeight:'bold',color:'white',margin:15}}>Weight Loss Easy</Text>
