...
export default class Abdiominalcrunches extends Component{
        ...
        return(
            ...
            <View style={{backgroundColor: '#f1f1f1',height:'100%',}}>
                <View style={{width:'100%',height:'42%'}}>
                    <Image
                        source={require('../gifs/abdiominalcrunches.gif')}
                        style={{width: undefined,height:undefined,flex:1}}
                    />
                </View>
                <Text style={{textAlign:'center',fontSize:25,color:'#ABABAB'}}>Abdominal crunches</Text>
                        ...
                        <View style={{flexDirection:'column',backgroundColor:'#f1f1f1',height:'100%',width:'100%'}}>
                            ...
                            <View style={{backgroundColor:'#fff',width:'95%',height:230,flexDirection:'row',flex:1,margin:5,borderRadius:15,justifyContent:'center',alignSelf:'center'}}>
                                <View style={{backgroundColor:'#fff',flex:.5,margin:10,flexDirection:'column'}}>
                                    ...
                                    <Image
                                        source={require('../detailimage/crunchprimary.png')}
                                ...
                                <View style={{backgroundColor:'#fff',flex:.5,margin:10,flexDirection:'column'}}>
                                    ...
                                    <Text style={{textAlign: 'center',fontSize:18,margin:5,color:'#ABABAB'}}>External abdominal</Text>
                                    <Image
                                        source={require('../detailimage/crunchsecondary.png')}
                                        style={{width: undefined,height:undefined,padding:15,flex:1}}
                                    />
                                </View>
                            </View>
                            ...
                            <View style={{flexDirection:'column',backgroundColor:'#f1f1f1',height:400,width:'100%'}}>
                                ...
                                <View style={{backgroundColor:'#fff',width:'95%',height:230,flexDirection:'column',flex:1,margin:5,borderRadius:15,justifyContent:'center',alignSelf:'center'}}>
                                    <View style={{backgroundColor:'#fff',flex:1,margin:10,flexDirection:'column'}}>
                                        <Text style={{textAlign: 'left',fontSize:25,margin:5,color:'#ABABAB'}}>Abdominal crunches</Text>
                                        <Text style={{textAlign: 'left',fontSize:18,margin:5,color:'#ABABAB',fontWeight:'bold'}}>Body Part: Abdominal area</Text>
                                        <Text style={{textAlign: 'left',fontSize:18,margin:5,color:'#ABABAB',fontWeight:'bold'}}>Discription</Text>
                                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#ABABAB'}}>{'\u2B24'} Lie on your back, and lift your legs and arms up so they are extended toward the ceiling.</Text>
                                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#ABABAB'}}>{'\u2B24'} Lift your upper back off the floor, reaching your hands toward your feet.</Text>
                                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#ABABAB'}}>{'\u2B24'} Lower your legs toward the floor while reaching your arms overhead, </Text>
                                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#ABABAB'}}>{'\u2B24'} keeping your shoulders off the mat and lower back pressed into the mat.</Text>
                                    </View>
