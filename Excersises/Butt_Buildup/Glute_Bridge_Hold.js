...
export default class Glute_Bridge_Hold extends Component{
        ...
        return(
            ...
            <View style={{backgroundColor: '#3C3C3C',height:'100%',}}>
                <Image
                    ...
                    style={{width: '80%',overlayColor: '#3C3C3C',borderRadius:15, marginTop:15,height:'50%',padding:15,margin:'3%',justifyContent:"center",alignItems:'center',alignSelf:"center"}}
                />

                <View style={{backgroundColor: '#E592D9',margin:15,borderRadius:15}}>
                    <ScrollView>
                        <Text style={{textAlign: 'left',margin:15,marginLeft:'11%',color:'#fff',fontSize:18}}>Action List</Text>

                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} move left</Text>
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} move left</Text>
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} move left</Text>
                        <Text style={{textAlign: 'left',marginLeft:'12%',marginBottom:5,color:'#fff'}}>{'\u2B24'} move left</Text>
