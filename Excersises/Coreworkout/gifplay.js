            ...
            dataSource: [
                {
                    ...
                    title: 'V Crunch',
                    caption: 'Working up',
                    url: require('../gifs/vcrunch.gif'),
                },{
                    title: 'plank with knee to elbow',
                    caption: 'Keep it up',
                    url: require('../gifs/plankwithkneetoelbow.gif'),
                },{
                    title: 'Plank',
                    caption: 'In progress',
        ...
        return (
            <View style={{flex:1,flexDirection:'column',backgroundColor:'#363636'}}>
                ...
                <ScrollView>
                    ...
                    <Text style={{textAlign:'center',fontSize:25,fontWeight:'bold',color:'white',margin:15}}>Core Workout</Text>
