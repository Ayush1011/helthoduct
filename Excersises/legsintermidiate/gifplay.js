            ...
            dataSource: [
                {
                    ...
                    url: require('../gifs/jumpingjack.gif'),
                },{
                    title: 'Squat Jump',
                    caption: 'Warming up',
                    ...
                    title: 'Fire hydrant ',
                    caption: 'Working up',
                    url: require('../gifs/firehydrant.gif'),
                },{
                    title: 'Lunge',
                    caption: 'Keep it up',
                    ...
                    title: 'Leg Circle',
                    caption: 'In progress',
                    url: require('../gifs/legcircle.gif'),
                },{
                    title: 'Sumo Squat',
                    caption: '4 more steps to completion',
                    url: require('../gifs/sumosquat.gif'),
                },{
                    title: 'Flutter Kick',
                    caption: 'You cant quit..',
                    url: require('../gifs/fultterkick.gif'),
                },{
                    title: 'Quad Stretch',
                    caption: 'Amazing things takes time',
                ...
                },
                {
                    ...
                    url: require('../gifs/singleleghop.gif'),
                },
        ...
        return (
            <View style={{flex:1,flexDirection:'column',backgroundColor:'#363636'}}>
                ...
                <ScrollView>
                    ...
                    <Text style={{textAlign:'center',fontSize:25,fontWeight:'bold',color:'white',margin:15}}>Legs Intermediate</Text>
