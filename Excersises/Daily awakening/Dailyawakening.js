...
import V_crunch from "../fullbodyeasy/V_crunch";
                ...
                <ScrollView>
                    ...
                    <View style={{width:'100%',
                        ...
                        <Image
                            ...
                            source={require('../mainImage/dailyawakning.jpg')}/>
                    ...
                    <View style={{flex:1,flexDirection:'column'}}>
                        ...
                        <View style={{flex:1,flexDirection:'column'}}>
                            ...
                            <View style={{width:'100%',margin:'5%',}}>
                                ...
                                <TouchableOpacity
                                    onPress={()=>this.props.navigation.navigate('Scissor')}
                                    ...
                                    <View style={{flex:1,flexDirection:'row'}}>
                                        ...
                                        <View style={{flex:1,flexDirection:'column',height:'100%'}}>
                                            <Text style={{margin:'5%',fontSize:18,color:'#787878'}} >Scissor Jump</Text>
                                ...
                                <TouchableOpacity
                                    onPress={()=>this.props.navigation.navigate('leglift')}
