            ...
            dataSource: [
                {
                    ...
                    url: require('../gifs/Jumping_jacks.gif'),
                },{
                    title: 'Squats',
                    caption: 'Warming up',
                    url: require('../gifs/Squatjump.gif'),
                },{
                    title: 'Hips Extension',
                    caption: 'Working up',
                    url: require('../gifs/hipextention.gif'),
                },{
                    title: 'Glute Kickback',
                    caption: 'Keep it up',
                    url: require('../gifs/Glute_back.gif'),
                },{
                    title: 'Calf Raise',
                    caption: 'In progress',
                    url: require('../gifs/Calf_raise.gif'),
                },{
                    title: 'Incline Push up',
                    caption: '6 more steps to completion',
                    url: require('../gifs/Incline_pushups.gif'),
                },{
                    title: 'Reverse Dumbbell fly',
                    caption: 'You can do it',
                    url: require('../gifs/reversedumbbellfly.gif'),
                },{
                    title: 'Arm circle',
                    caption: 'You cant give up now',
                    url: require('../gifs/dumbbellarmcircle.gif'),
                },
                {
                    title: 'Dumbbell triceps extension',
                    caption: '4 more to go',
                    url: require('../gifs/Triceps_Dumbell.gif'),
                },
                {
                    title: 'Dumbbell biceps curl',
                    caption: 'Its mostly your brain',
...

                {
                    ...
                    url: require('../gifs/Mountain_Climber.gif'),
                },
            ],
        };
    }
        ...
        return (
            <View style={{flex:1,flexDirection:'column',backgroundColor:'#363636'}}>
                ...
                <ScrollView>
                    ...
                    <Text style={{textAlign:'center',fontSize:25,fontWeight:'bold',color:'white',margin:15}}>Weight Loss Intermediate</Text>
